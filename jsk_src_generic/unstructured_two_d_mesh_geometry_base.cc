...
namespace oomph
{
  ...
  TriangleMeshClosedCurve::TriangleMeshClosedCurve(
    ...
    : TriangleMeshCurve(curve_section_pt), Internal_point_pt(internal_point_pt)
  {
    ...
    Vector<Vector<double>> polygon_vertices, Vector<double>& point_inside_coord)
  {
    ...
    bool is_point_inside =
      UnstructuredTwoDMeshGeometryBase::is_point_inside_polygon_helper(
        polygon_vertices, point_inside_coord);
