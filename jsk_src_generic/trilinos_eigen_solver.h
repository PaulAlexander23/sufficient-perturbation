...
class AdjointProblemBasedShiftInvertOperator: public DoubleMultiVectorOperator
{
private:
 //Pointer to the problem
 Problem* Problem_pt;
...
public:
 ...
 AdjointProblemBasedShiftInvertOperator(Problem* const &problem_pt,
					LinearSolver* const &linear_solver_pt,
					const double &sigma=0.0) :
 Problem_pt(problem_pt), Linear_solver_pt(linear_solver_pt), Sigma(sigma)
  {
   ...
   //JACK - get the transpose of the mass and jacobian
   /////////////////////////////////////////////////////////
   /////////////////////////////////////////////////////////
...
//  MyPL.set( "Num Blocks", ncv );
				 ...
				 Vector<DoubleVector> &eigenvector)
 {
  ...
  Teuchos::RCP<DoubleMultiVectorOperator> Op_pt =
   Teuchos::rcp(
    new AdjointProblemBasedShiftInvertOperator(problem_pt,
                                        this->linear_solver_pt(),Sigma));
