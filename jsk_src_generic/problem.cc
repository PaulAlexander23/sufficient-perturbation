...
//LIC// 
//LIC//    Version 1.0; svn revision $LastChangedRevision: 1302 $
//LIC//
//LIC// $LastChangedDate: 2017-10-23 12:52:19 +0100 (Mon, 23 Oct 2017) $
//LIC// 
 ...
 if(steady)
  {
   ...
   //Call the Eigenproblem for the eigensolver
   Eigen_solver_pt->solve_adjoint_eigenproblem(this,n_eval,eigenvalue,eigenvector);
