...
namespace oomph
{
  ...
  public:
    ...
    static void find_point_inside_polygon_helper(
      Vector<Vector<double>> polygon_vertices, Vector<double>& point);
  ...
  protected:
      ...
      TriangleMeshClosedCurve* closed_curve_pt, unsigned& max_bnd_id_local)
    {
      ...
      TriangleMeshPolygon* output_polygon_pt = new TriangleMeshPolygon(
        my_boundary_polyline_pt, closed_curve_pt->internal_point());
