...
// LIC//
// LIC//    Version 1.0; svn revision $LastChangedRevision: 1286 $
// LIC//
// LIC// $LastChangedDate: 2017-01-25 23:19:58 +0000 (Wed, 25 Jan 2017) $
// LIC//
...
namespace oomph
{
  ...
  protected:
    ...
    /*   // \short Stores the initial arclength for the segments that appear
     * when */
    /*   // a boundary is splited among processors (data from previous mesh) */
    /*   std::map<unsigned, Vector<double> >
     * Boundary_segment_initial_arclength_previous_mesh; */
