...
class HeleShawVolumeConstraintElement : public
...
//            std::cout << "Volume dof " << residuals[local_eqn] << std::endl;
        }
    }
...
template<class ELEMENT>
class HeleShawCoMXConstraintElement : public
    LineVolumeConstraintBoundingElement,
public virtual FaceGeometry<ELEMENT>
{
public :
...
template<class ELEMENT>
class HeleShawCoMYConstraintElement : public
    LineVolumeConstraintBoundingElement,
public virtual FaceGeometry<ELEMENT>
{
public :
...
//            std::cout << "CoM dof" << std::endl;
            ...
            for(unsigned ipt=0; ipt<n_intpt; ipt++)
            {
                ...
                // Assemble dot product
                double dot = interpolated_x[0]*interpolated_x[1]*interpolated_n[0]*b;
...
/// The Data is stored as external Data for this element.
    SelfReferentialVolumeConstraintElement(double* prescribed_volume_pt,
...
//        VolumeConstraintElement::fill_in_contribution_to_jacobian(residuals,jacobian);
        ...
        GeneralisedElement::fill_in_jacobian_from_external_by_fd(residuals, jacobian,false);
    }
    ...
    void fill_in_contribution_to_residuals_self_referential(Vector<double> &residuals)
    {
